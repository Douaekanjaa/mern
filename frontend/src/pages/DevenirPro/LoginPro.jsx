    ...
    return (
        <section className="relative flex flex-wrap lg:h-screen lg:items-center w-full">
            <div className="relative h-64 w-full sm:h-96 lg:h-full lg:w-1/2">
                <img
                    alt=""
                    src="../public/images/loginpro.png"
                    className="absolute inset-0 h-full w-full object-cover"
                />
            </div>
            <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
                <div className="mx-auto max-w-lg text-center">
                    <h1 className="text-2xl font-bold sm:text-3xl text-lime-600">Welcome Back, Pro!</h1>
                    
                    
                    <p className="mt-2 text-gray-700">
                    Join our community of skilled pros to showcase your expertise, manage projects, communicate with clients, and get paid securely.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <p className="text-sm text-gray-500">
                            No account?
                            <a className="underline" href="/become-a-pro">Register</a>
                        </p>
                        <button
                            type="submit"
